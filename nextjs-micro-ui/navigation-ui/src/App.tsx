...
const App = () => {
  ...
  const [MainSelection, setMainSelection] = useState({id: 'def', name: ''});
  ...
  const handleProfileClick = () => {
    window.dispatchEvent(new CustomEvent('mainSelectionChanged', {
      detail: { id: 'profile', name: 'profile'}
    }));
  }

  const handleDiscoverSelection = (selection) => {
    setDiscoverSelection(selection);
    setMainSelection(selection);
    window.dispatchEvent(new CustomEvent('mainSelectionChanged', {
      detail: { id: 'disc', name: selection.name }
    }));
  }
            ...
            <div className="DiscoverDropmenu">
              <div className='DiscoverComponentUnCollapsed'>
                ...
                <div className='NavigationDiscoverContent'>
                  {isDiscoverdropdownOpen && <Discover Searchtype={Searchtype} DiscoverSelection={DiscoverSelection} handleDiscoverSelection={handleDiscoverSelection} setisSelected={setisSelected}/>}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="GeographyDropmenu">
              <div className='GeographyComponentUnCollapsed'>
                ...
                <div className='NavigationGeographyContent'>
                  {isgeodropdownOpen && <Geographies Searchtype={Searchtype} GeographiesSelection={GeographiesSelection} handleGeographiesSelection={handleGeographiesSelection} setisSelected={setisSelected}/>}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='lower-level-elements'>
          {isCollapsed && (
            <div className='FooterNavigationCollapsed'>
              <div className='SavedTagNavigation' onClick={handleLogout}>
              ...
              <div className='SettingsNavigation' onClick={handleProfileClick}>
            ...
            <div className='Collapse-button' >
              {isCollapsed ? (
                ...
                <div className='Footer-final'>
                  <div className='SettingsFooterNavigationIcon' onClick={handleProfileClick}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>
                  </div>
                  <div className='SavedTagFooterNavigation' onClick={handleLogout}>
                    <svg fill="#cccccc" height="40" width="40" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 400 400" enableBackground="new 0 0 500 500" xmlSpace="preserve" stroke="#ffffff" strokeWidth="8.5" transform="rotate(0)"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#CCCCCC" strokeWidth="1"></g><g id="SVGRepo_iconCarrier"> <g> <path d="M250,224c-4.4,0-8,3.6-8,8v24c0,4.4-3.6,8-8,8h-40c-4.4,0-8-3.6-8-8V144c0-4.4,3.6-8,8-8h40c4.4,0,8,3.6,8,8v24 c0,4.4,3.6,8,8,8s8-3.6,8-8v-24c0-13.2-10.8-24-24-24h-40c-13.2,0-24,10.8-24,24v112c0,13.2,10.8,24,24,24h40c13.2,0,24-10.8,24-24 v-24C258,227.6,254.4,224,250,224z"></path> <path d="M328.4,204.8c0.1-0.1,0.2-0.2,0.3-0.3c0,0,0,0,0-0.1c0.1-0.2,0.2-0.4,0.3-0.6c0.1-0.3,0.3-0.5,0.4-0.8 c0.1-0.3,0.2-0.5,0.3-0.8c0.1-0.2,0.2-0.4,0.2-0.7c0.2-1,0.2-2.1,0-3.1c0,0,0,0,0,0c0-0.2-0.1-0.4-0.2-0.7 c-0.1-0.3-0.1-0.5-0.2-0.8c0,0,0,0,0,0c-0.1-0.3-0.3-0.5-0.4-0.8c-0.1-0.2-0.2-0.4-0.3-0.6c-0.3-0.4-0.6-0.9-1-1.2l-32-32 c-3.1-3.1-8.2-3.1-11.3,0c-3.1,3.1-3.1,8.2,0,11.3l18.3,18.3H210c-4.4,0-8,3.6-8,8s3.6,8,8,8h92.7l-18.3,18.3 c-3.1,3.1-3.1,8.2,0,11.3c1.6,1.6,3.6,2.3,5.7,2.3s4.1-0.8,5.7-2.3l32-32c0,0,0,0,0,0C327.9,205.4,328.1,205.1,328.4,204.8z"></path> </g> </g></svg>                
                    </div>
